...
--
-- Host: localhost:3306
-- Gegenereerd op: 24 mrt 2021 om 13:50
-- Serverversie: 5.7.25
-- PHP-versie: 7.3.1
...
(2, 'admin@test.nl', '', NULL, NULL, '2021-03-04 08:06:57');
...
(1, 'arstid', 'Een prachtige designlamp van de welbekende designer Wolle-bulle. Deze lamp geeft licht aan uw interieur.', 3, 26.50, 'white', 1.20, 1),
